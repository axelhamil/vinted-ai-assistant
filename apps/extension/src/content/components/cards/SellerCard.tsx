					...
					<CardRow
						...
						value={
							<span className="flex items-center gap-1">
								<svg className="w-4 h-4 text-caution" fill="currentColor" viewBox="0 0 20 20">
				...
				<div className="mt-3 p-2 rounded-lg bg-caution/10 border border-caution/20">
					<div className="flex items-start gap-2">
						...
						<p className="text-lg text-caution">
							Vérifiez le profil du vendeur avant d'acheter. Les données disponibles sont insuffisantes pour
