...
export function ArticleCard({ article }: ArticleCardProps) {
	...
	return (
		<button
			type="button"
			onClick={handleClick}
			className="flex w-full items-center gap-3 rounded-lg border border-gray-200 bg-white p-2 text-left transition-colors hover:bg-gray-50"
		>
			{/* Thumbnail */}
			...
			<div className="flex-1 min-w-0">
				...
				<div className="mt-1 flex items-center gap-2">
					<span className="text-sm font-semibold text-gray-900">{formatPrice(article.price)}</span>
